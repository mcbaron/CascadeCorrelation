...
const max_iter_delta = 100 # max iterations for -output retraining
const max_iter_cand = 100 # max iterations for candidate unit training (input-hidden_candidate)
const n_candidates = 10 # how many candidate units will be initialized on adding each hidden neuron
const max_hidden = 3 # maximum amount of hidden units
